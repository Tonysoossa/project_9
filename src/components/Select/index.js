...
const Select = ({
  ...
  const changeValue = (newValue) => {
     // NOTE Fonction pour mettre à jour la valeur "value" et "collapsed" lorsqu'une nouvelle valeur est sélectionnée.
    onChange(newValue); // NOTE Appelle la fonction "onChange" passée en tant que propriété avec la nouvelle valeur.
    setValue(newValue); // NOTE Met à jour la valeur "value" avec la nouvelle valeur.
    setCollapsed(newValue);  // NOTE Met à jour "collapsed" en fonction de la nouvelle valeur
  };
  return (
